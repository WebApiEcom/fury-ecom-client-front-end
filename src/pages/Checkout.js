...
function Checkout() {
    ...
    const email = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InpzaHRtYWRAZ21haWwuY29tIiwiaWF0IjoxNjI5ODA0ODE4fQ.Xc7vLZ6giavNqROPjDhGucyl11O9E2HSSw4nUW6Sruk";
                        ...
                        <div className="flex-grow-0 flex-shrink-0 w-8/12 mb-7 mx-2 px-2">
                            <div className="mb-2.5 py-5 px-7 bg-white rounded-t-lg rounded-b-lg">
                                <div className="relative">
                                    <p class="text-lg text-black font-bold mb-6 mt-2">Shipping Information</p>
                                    <div className="relative ">
                                        <div className="w-4/5 inline-grid overflow-hidden">
                                            <div className="font-bold mb-0375 break-all">
                                                {name}, +94 {phoneNo}
                                            </div>
                                            <div className="leading-cus2">{addressNo} {lane}, {city}</div>
                                    ...
                                    <div className="absolute right-0 bottom-2.5 flex flex-col items-end mt-4 pl-cus2 ">
                                        <button className="rounded-none p-0 h-5 border-0 text-cus text-xs">+ Add new address</button>
                                        <button className="rounded-none p-0 h-5 border-0 text-cus mb-0 text-xs">Select other addresses</button>
                                    </div>
                                </div>
                            </div>
                            <div className="mb-2.5 py-5 px-7 bg-white rounded-t-lg rounded-b-lg">
                                <div className="w-full relative">
                                    <div className="w-full text-lg text-black font-bold pt-0 px-0 pb-3">Payment Methods</div>
                            ...
                            <div className="mb-2.5 py-5 px-7 bg-white rounded-t-lg rounded-b-lg">
                                <div class="relative">
                                    <p class="text-lg text-black font-bold mb-6 mt-2">Order Review</p>
                                    {
                                        ...
                                        <div class="relative">
                                            ...
                                            <div className="border border-solid border-gray-100 my-5 pt-4 text-black">
                                                <dl className="flex flex-wrap items-center text-sm m-0">
                                                    <dt className="flex-grow flex-shrink text-sm font-bold">Total</dt>
                                                    <dd className="m-0 pl-2 text-2xl font-bold">Rs. {orderTotal}</dd>
                                                </dl>
                                            </div>
